...
class gltfShader
{
    constructor(program, hash)
    {
        ...
        {
            const uniformCount = WebGl.context.getProgramParameter(this.program, WebGL2RenderingContext.ACTIVE_UNIFORMS);
            ...
            const attribCount = WebGl.context.getProgramParameter(this.program, WebGL2RenderingContext.ACTIVE_ATTRIBUTES);
    ...
    updateUniformValue(uniformName, value, log)
    {
        ...
        if(uniform !== undefined)
        {
            ...
            case WebGL2RenderingContext.FLOAT_VEC2: WebGl.context.uniform2fv(uniform.loc, value); break;
            case WebGL2RenderingContext.FLOAT_VEC3: WebGl.context.uniform3fv(uniform.loc, value); break;
            case WebGL2RenderingContext.FLOAT_VEC4: WebGl.context.uniform4fv(uniform.loc, value); break;
            ...
            case WebGL2RenderingContext.INT_VEC2: WebGl.context.uniform2iv(uniform.loc, value); break;
            case WebGL2RenderingContext.INT_VEC3: WebGl.context.uniform3iv(uniform.loc, value); break;
            case WebGL2RenderingContext.INT_VEC4: WebGl.context.uniform4iv(uniform.loc, value); break;

            case WebGL2RenderingContext.FLOAT_MAT2: WebGl.context.uniformMatrix2fv(uniform.loc, false, value); break;
            case WebGL2RenderingContext.FLOAT_MAT3: WebGl.context.uniformMatrix3fv(uniform.loc, false, value); break;
            case WebGL2RenderingContext.FLOAT_MAT4: WebGl.context.uniformMatrix4fv(uniform.loc, false, value); break;
            }
        }
        else if(log)
        {
